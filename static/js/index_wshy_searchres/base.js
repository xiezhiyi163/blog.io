var created_ = function(){},
	datas = {
		pricesort:'up',
		starsort:'up',
		searchboxwidth:'0',//筛选盒子的盒子宽控制
		searchboxAni:'searchboxclose 0.0s forwards',//黑色遮罩使用的切换动画
		m:true,
		items:[
			{
	...
	methods_ = {
		...
		submits:function(){
			...
			setTimeout(function(){
				...
				_this.searchboxwidth=='0'?_this.searchboxwidth = '6.3rem':_this.searchboxwidth = '0';_this.searchboxAni.indexOf('searchboxshow')!=-1?(_this.searchboxAni = 'searchboxclose 0.3s forwards'):(_this.searchboxAni = 'searchboxshow 0.3s forwards');				
			},500)
		},
		//切换
		...
		//去商家
		gotoshop:function(){
			window.location.href = 'index_wshy_buiness.html'
		},
		//mescroll
		mescrollFn:function(){
			new MeScroll('mesapp')
